...
F.C = {
  ...
  PERSONAS: [
    { id: 'calm-narrator', name: 'Calm Narrator', tagline: 'Even, unhurried, low-key. Built for long sessions and late nights.', rate: 0.95, pitch: 0.95,
      ...
      kokoroVoice: 'af_heart', kokoroSpeed: 0.95, googleVoice: ['en-US-Chirp3-HD-Aoede', 'en-US-Neural2-F'], piperVoice: 'en_US-hfc_female-medium', elevenHints: ['River', 'Sarah', 'Eric', 'Matilda'] },
    { id: 'warm-storyteller', name: 'Warm Storyteller', tagline: 'Friendly and expressive, like being read to by someone who loves the book.', rate: 1.0, pitch: 1.05,
      ...
      kokoroVoice: 'af_bella', kokoroSpeed: 1.0, googleVoice: ['en-US-Chirp3-HD-Leda', 'en-US-Neural2-C'], piperVoice: 'en_US-amy-medium', elevenHints: ['George', 'Jessica', 'Laura', 'Chris'] },
    { id: 'measured-academic', name: 'Measured Academic', tagline: 'Precise and articulate. Good for non-fiction, essays, and dense passages.', rate: 0.92, pitch: 0.9,
      ...
      kokoroVoice: 'bm_george', kokoroSpeed: 0.92, googleVoice: ['en-GB-Chirp3-HD-Charon', 'en-GB-Neural2-B'], piperVoice: 'en_GB-alan-medium', elevenHints: ['Bill', 'Matilda', 'Alice', 'Daniel'] },
    { id: 'bright-brisk', name: 'Bright & Brisk', tagline: 'Lively and quick. For light reading and getting through a lot of pages.', rate: 1.15, pitch: 1.1,
      ...
      kokoroVoice: 'am_puck', kokoroSpeed: 1.12, googleVoice: ['en-US-Chirp3-HD-Puck', 'en-US-Neural2-H'], piperVoice: 'en_US-kristin-medium', elevenHints: ['Laura', 'Liam', 'Jessica', 'Will'] },
    { id: 'late-night-low', name: 'Late-Night Low', tagline: 'Deep, slow and quiet. The bedtime voice.', rate: 0.88, pitch: 0.85,
      ...
      kokoroVoice: 'am_fenrir', kokoroSpeed: 0.88, googleVoice: ['en-US-Chirp3-HD-Fenrir', 'en-US-Neural2-D'], piperVoice: 'en_US-joe-medium', elevenHints: ['Brian', 'Bill', 'Roger', 'George'] },
    { id: 'crisp-newsreader', name: 'Crisp Newsreader', tagline: 'Neutral, clear and efficient. For articles, reports and reference.', rate: 1.05, pitch: 1.0,
      ...
      kokoroVoice: 'am_michael', kokoroSpeed: 1.02, googleVoice: ['en-US-Chirp3-HD-Orus', 'en-US-Neural2-J'], piperVoice: 'en_US-ryan-medium', elevenHints: ['Daniel', 'Eric', 'Sarah', 'Alice'] },
    ...
    { id: 'the-philosopher', name: 'The Philosopher', tagline: 'A slow, contemplative baritone that lets a sentence land. For essays, dialogues and dense ideas.', rate: 0.86, pitch: 0.85, group: 'Readers',
      ...
      kokoroVoice: 'bm_george', kokoroSpeed: 0.88, piperVoice: 'en_GB-northern_english_male-medium', elevenHints: ['Bill', 'Brian', 'George', 'Daniel'], googleVoice: ['en-GB-Chirp3-HD-Charon', 'en-US-Chirp3-HD-Charon', 'en-GB-Neural2-D'] },
    { id: 'lecture-hall', name: 'Lecture Hall', tagline: 'Articulate and structured, with the cadence of a good university lecture. For non-fiction and argument.', rate: 0.97, pitch: 0.95, group: 'Readers',
      ...
      kokoroVoice: 'bm_fable', kokoroSpeed: 0.97, piperVoice: 'en_GB-alan-medium', elevenHints: ['Alice', 'Matilda', 'Daniel', 'Bill'], googleVoice: ['en-GB-Chirp3-HD-Fenrir', 'en-GB-Neural2-B', 'en-US-Chirp3-HD-Charon'] },
    { id: 'fireside', name: 'Fireside', tagline: 'Gravelly, close and unhurried, like a story told across a table. For novels and memoir.', rate: 0.92, pitch: 0.88, group: 'Readers',
      ...
      kokoroVoice: 'am_fenrir', kokoroSpeed: 0.92, piperVoice: 'en_US-joe-medium', elevenHints: ['George', 'Roger', 'Callum', 'Brian'], googleVoice: ['en-US-Chirp3-HD-Fenrir', 'en-US-Neural2-D', 'en-US-Chirp3-HD-Charon'] },
    { id: 'the-essayist', name: 'The Essayist', tagline: 'Poised, precise, lightly wry. For essays, criticism and letters.', rate: 0.96, pitch: 1.0, group: 'Readers',
      ...
      kokoroVoice: 'bf_emma', kokoroSpeed: 0.95, piperVoice: 'en_GB-jenny_dioco-medium', elevenHints: ['Matilda', 'Alice', 'Sarah', 'Lily'], googleVoice: ['en-GB-Chirp3-HD-Aoede', 'en-GB-Neural2-A', 'en-US-Chirp3-HD-Kore'] },
    { id: 'broadcast', name: 'Broadcast', tagline: 'Rounded, resonant, evenly paced. The public-radio register for journalism and history.', rate: 1.0, pitch: 0.92, group: 'Readers',
      ...
      kokoroVoice: 'am_michael', kokoroSpeed: 0.98, piperVoice: 'en_US-hfc_male-medium', elevenHints: ['Daniel', 'Brian', 'Eric', 'Bill'], googleVoice: ['en-US-Chirp3-HD-Charon', 'en-US-Neural2-J', 'en-US-Chirp3-HD-Orus'] },
    { id: 'close-mic', name: 'Close Mic', tagline: 'Soft and near, almost a whisper. The bedtime voice for poetry and quiet books.', rate: 0.9, pitch: 0.95, group: 'Readers',
      ...
      kokoroVoice: 'af_nicole', kokoroSpeed: 0.9, piperVoice: 'en_US-hfc_female-medium', elevenHints: ['Lily', 'River', 'Sarah', 'Jessica'], googleVoice: ['en-US-Chirp3-HD-Leda', 'en-US-Neural2-F', 'en-US-Chirp3-HD-Aoede'] },
  ],
