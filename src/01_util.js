...
F.C = {
  ...
  PERSONAS: [
    ...
    { id: 'crisp-newsreader', name: 'Crisp Newsreader', tagline: 'Neutral, clear and efficient. For articles, reports and reference.', rate: 1.05, pitch: 1.0,
      ...
      kokoroVoice: 'am_michael', kokoroSpeed: 1.02, googleVoice: ['en-US-Chirp3-HD-Orus', 'en-US-Neural2-J'] },
    ...
    { id: 'the-philosopher', name: 'The Philosopher', tagline: 'A slow, contemplative baritone that lets a sentence land. For essays, dialogues and dense ideas.', rate: 0.86, pitch: 0.85, group: 'Readers',
      ...
      kokoroVoice: 'bm_george', kokoroSpeed: 0.88, googleVoice: ['en-GB-Chirp3-HD-Charon', 'en-US-Chirp3-HD-Charon', 'en-GB-Neural2-D'] },
    { id: 'lecture-hall', name: 'Lecture Hall', tagline: 'Articulate and structured, with the cadence of a good university lecture. For non-fiction and argument.', rate: 0.97, pitch: 0.95, group: 'Readers',
      ...
      kokoroVoice: 'bm_fable', kokoroSpeed: 0.97, googleVoice: ['en-GB-Chirp3-HD-Fenrir', 'en-GB-Neural2-B', 'en-US-Chirp3-HD-Charon'] },
    { id: 'fireside', name: 'Fireside', tagline: 'Gravelly, close and unhurried, like a story told across a table. For novels and memoir.', rate: 0.92, pitch: 0.88, group: 'Readers',
      ...
      kokoroVoice: 'am_fenrir', kokoroSpeed: 0.92, googleVoice: ['en-US-Chirp3-HD-Fenrir', 'en-US-Neural2-D', 'en-US-Chirp3-HD-Charon'] },
    { id: 'the-essayist', name: 'The Essayist', tagline: 'Poised, precise, lightly wry. For essays, criticism and letters.', rate: 0.96, pitch: 1.0, group: 'Readers',
      ...
      kokoroVoice: 'bf_emma', kokoroSpeed: 0.95, googleVoice: ['en-GB-Chirp3-HD-Aoede', 'en-GB-Neural2-A', 'en-US-Chirp3-HD-Kore'] },
    { id: 'broadcast', name: 'Broadcast', tagline: 'Rounded, resonant, evenly paced. The public-radio register for journalism and history.', rate: 1.0, pitch: 0.92, group: 'Readers',
      ...
      kokoroVoice: 'am_michael', kokoroSpeed: 0.98, googleVoice: ['en-US-Chirp3-HD-Charon', 'en-US-Neural2-J', 'en-US-Chirp3-HD-Orus'] },
    { id: 'close-mic', name: 'Close Mic', tagline: 'Soft and near, almost a whisper. The bedtime voice for poetry and quiet books.', rate: 0.9, pitch: 0.95, group: 'Readers',
      ...
      kokoroVoice: 'af_nicole', kokoroSpeed: 0.9, googleVoice: ['en-US-Chirp3-HD-Leda', 'en-US-Neural2-F', 'en-US-Chirp3-HD-Aoede'] },
  ],
  // Curated on-device (Kokoro) voices with grades from the model card; the rest are available but weaker.
  KOKORO_VOICES: [
    { id: 'af_heart', name: 'Heart', desc: 'Warm American, the all-rounder', grade: 'A' },
    { id: 'af_bella', name: 'Bella', desc: 'Bright, expressive American', grade: 'A-' },
    { id: 'af_nicole', name: 'Nicole', desc: 'Soft, close-mic, late-night', grade: 'B-' },
    { id: 'bf_emma', name: 'Emma', desc: 'Poised British', grade: 'B-' },
    { id: 'af_aoede', name: 'Aoede', desc: 'Clear, even American', grade: 'C+' },
    { id: 'af_kore', name: 'Kore', desc: 'Calm, lower American', grade: 'C+' },
    { id: 'af_sarah', name: 'Sarah', desc: 'Friendly American', grade: 'C+' },
    { id: 'am_michael', name: 'Michael', desc: 'Deep American, broadcast', grade: 'C+' },
    { id: 'am_fenrir', name: 'Fenrir', desc: 'Gravelly American, fireside', grade: 'C+' },
    { id: 'am_puck', name: 'Puck', desc: 'Light, quick American', grade: 'C+' },
    { id: 'bm_george', name: 'George', desc: 'Measured British baritone', grade: 'C' },
    { id: 'bm_fable', name: 'Fable', desc: 'British storyteller', grade: 'C' },
    { id: 'bf_isabella', name: 'Isabella', desc: 'Gentle British', grade: 'C' },
  ],
